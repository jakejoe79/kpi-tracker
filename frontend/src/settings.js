...
function Settings({ goals, setGoals, onSettingsChange }) {
  ...
  const exampleBase = exampleAmount * conversion.exchange_rate;
  const exampleFee = exampleBase * (conversion.processing_fee_percent / 100);
  ...
  return (
    <div data-testid="settings">
      ...
      <div className="card" style={{ marginBottom: '1.5rem', background: '#FEF3C7', border: '2px solid #F59E0B' }}>
        ...
        <div style={{ marginTop: '1rem', padding: '1rem', background: 'white', borderRadius: '8px', border: '1px solid #F59E0B' }}>
          <p style={{ fontSize: '0.875rem', color: '#92400E', marginBottom: '0.5rem', fontWeight: 'bold' }}>
            Example: ${exampleAmount} USD → {conversion.exchange_rate} rate + {conversion.processing_fee_percent}% fee
          </p>
